...
!!! example "Schema Diagram"
    ...
    <div style="text-align: center"><img src="images/image-5.png" width="65%"></div>
...
!!! tip "双重否定的思想"
    ...
    <div style="text-align: center"><img src="images/image-3.png" width="60%"></div>
...
??? example
    ...
    More examples
       ...
       <div style="text-align: center"><img src="images/image-15.png" width="65%"></div>
