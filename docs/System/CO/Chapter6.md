...
<div style="text-align: center"><img src="images/image-162.png" width="70%"></div>
...
!!! example "硬盘读取时间"
    ...
    <div style="text-align: center"><img src="images/image-164.png" width="90%"></div>
...
!!! note "Array Reliability"
    ...
    <div style="text-align: center"><img src="images/image-165.png" width="80%"></div>
...
!!! example "A disk arrays replace larger disk"
    ...
    <div style="text-align: center"><img src="images/image-166.png" width="85%"></div>

    - 不同的 RAID 模式

    <div style="text-align: center"><img src="images/image-167.png" width="85%"></div>
...
!!! tip
    ...
    - 一对一的进行复制备份
      ...
      <div style="text-align: center"><img src="images/image-168.png" width="80%"></div>
...
<div style="text-align: center"><img src="images/image-169.png" width="65%"></div>
...
<div style="text-align: center"><img src="images/image-170.png" width="70%"></div>
...
!!! note "Write Penalty"
    ...
    <div style="text-align: center"><img src="images/image-171.png" width="65%"></div>
...
<div style="text-align: center"><img src="images/image-173.png" width="60%"></div>
...
??? note "Two operations"
    ...
    <div style="text-align: center"><img src="images/image-174.png" width="80%"></div>

    - output: sending data to a device from memory

    <div style="text-align: center"><img src="images/image-175.png" width="80%"></div>
...
<div style="text-align: center"><img src="images/image-176.png" width="80%"></div>

<div style="text-align: center"><img src="images/image-177.png" width="80%"></div>
...
!!! example "Asynchronous Example"
    ...
    <div style="text-align: center"><img src="images/image-178.png" width="85%"></div>
...
<div style="text-align: center"><img src="images/image-179.png" width="80%"></div>
...
!!! example
    ...
    <div style="text-align: center"><img src="images/image-181.png" width="75%"></div>

    <div style="text-align: center"><img src="images/image-182.png" width="75%"></div>
...
??? example "Increasing the Bus Bandwidth"
    ...
    <div style="text-align: center"><img src="images/image-183.png" width="80%"></div>

    - the 4-word Block Transfers

    <div style="text-align: center"><img src="images/image-184.png" width="80%"></div>

    <div style="text-align: center"><img src="images/image-185.png" width="75%"></div>

    - the 16-word Block Transfers

    <div style="text-align: center"><img src="images/image-186.png" width="75%"></div>

    <div style="text-align: center"><img src="images/image-187.png" width="75%"></div>

    <div style="text-align: center"><img src="images/image-188.png" width="75%"></div>
...
!!! info "Interrupt-Driven I/O Mode"
    ...
    <div style="text-align: center"><img src="images/image-189.png" width="80%"></div>
...
!!! info "DMA Transfer Mode"
    ...
    <div style="text-align: center"><img src="images/image-190.png" width="75%"></div>
...
!!! question
    ...
    <div style="text-align: center"><img src="images/image-191.png" width="80%"></div>
