...
!!! info "Memory Hierarchy Levels"
    ...
    <div style="text-align: center"><img src="images/image-114.png" width="75%"></div>
...
<div style="text-align: center"><img src="images/image-115.png" width="80%"></div>设计内存层级时，需要考虑的两个重要问题是内存访问**速度**(speed) 以及内存空间**大小**(size)，因此我们有了**高速缓存**(cache) 和**虚拟内存**(virtual memory) 的概念。
...
<div style="text-align: center"><img src="images/image-117.png" width="70%"></div>
...
!!! example "Mapping an Address to Multiword Cache Block"
    ...
    <div style="text-align: center"><img src="images/image-124.png" width="85%"></div>
...
!!! info "衡量失效的 3C 模型"
    ...
    - **冲突失效**(conflict/collision misses)：在**组相联**与**直接映射**的置放方案中，可能会遇到多个块在同一个集内竞争的情况
      ...
      <div style="text-align: center"><img src="images/image-197.png" width="70%"></div>

      Solution

    <div style="text-align: center"><img src="images/image-198.png" width="90%"></div>
...
<div style="text-align: center"><img src="images/image-126.png" width="80%"></div>
...
<div style="text-align: center"><img src="images/image-132.png" width="60%"></div>
...
!!! info "Larger Blocks Exploit Spatial Locality"
    ...
    <div style="text-align: center"><img src="images/image-133.png" width="80%"></div>
...
??? example "Calculating Cache Performance"
    ...
    <div style="text-align: center"><img src="images/image-138.png" width="80%"></div>

    加快时钟频率可以提高性能

    <div style="text-align: center"><img src="images/image-139.png" width="80%"></div>
...
<div style="text-align: center"><img src="images/image-141.png" width="65%"></div>
...
??? example "Miss rate versus set-associativity — 8 Blocks"
    ...
    <div style="text-align: center"><img src="images/image-142.png" width="80%"></div>

    - set-associated cache 

    <div style="text-align: center"><img src="images/image-143.png" width="80%"></div>

    - 最终结果，可见 data miss rate 逐渐下降

     <div style="text-align: center"><img src="images/image-144.png" width="80%"></div>

**Locating a block in the set-associative cache**

<div style="text-align: center"><img src="images/image-145.png" width="80%"></div>
...
??? example "Size of tags versus set associativity"
    ...
    <div style="text-align: center"><img src="images/image-146.png" width="80%"></div>

    <div style="text-align: center"><img src="images/image-147.png" width="80%"></div>
...
!!! example
    ...
    <div style="text-align: center"><img src="images/image-148.png" width="85%"></div>

    <div style="text-align: center"><img src="images/image-150.png" width="85%"></div>
...
<div style="text-align: center"><img src="images/image-151.png" width="90%"></div>
...
<div style="text-align: center"><img src="images/image-152.png" width="85%"></div>
...
<div style="text-align: center"><img src="images/image-154.png" width="75%"></div>

Each program has its own page table

- Virtual memory systems use **fully associative mapping** method

<div style="text-align: center"><img src="images/image-155.png" width="85%"></div>
...
<div style="text-align: center"><img src="images/image-160.png" width="75%"></div>
...
<div style="text-align: center"><img src="images/image-157.png" width="75%"></div>

!!! note "FastMATH Memory Hierarchy"

    一种更高效的访问结构

    <div style="text-align: center"><img src="images/image-158.png" width="75%"></div>

!!! note "流程图"

    **TLBs and Caches**

    <div style="text-align: center"><img src="images/image-159.png" width="80%"></div>
