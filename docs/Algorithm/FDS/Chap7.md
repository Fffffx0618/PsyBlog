...
## 4. Shellsort
![image-20250507142708116](数据结构基础.assets/image-20250507142708116.png)
...
![image-20250507152213200](数据结构基础.assets/image-20250507152213200.png)
...
![image-20250514144928822](数据结构基础.assets/image-20250514144928822.png)
...
* 如何输出排好序的列表：`list[table[0]], list[table[1]], ..., list[table[n-1]]`
  <img src="数据结构基础.assets/image-20250514192913570.png" alt="image-20250514192913570" style="zoom: 67%;" />
...
* ***Decision Tree 决策树***
  <img src="数据结构基础.assets/image-20250514193814214.png" alt="image-20250514193814214" style="zoom: 50%;" />
...
### 10.2 Radix Sort
* When $M>>N$,
<img src="数据结构基础.assets/image-20250514194034014.png" alt="image-20250514194034014" style="zoom:80%;" />
