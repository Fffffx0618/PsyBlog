# Lec2.Red-Black Trees and B+ Trees
...
| -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
|                                                                                                                                                          |                                                                                                             |
| - 首先染红 X 的兄弟 S- 然后将 X 的黑色丢给它的父节点 P	- 若原来 P 为红色，则现在 P 为**黑色**（结束）	- 若原来 P 为黑色，则现在 P 为**双黑** | - 如果染色后 P 为黑色，那么这棵子树处理结束- 如果染色后 P 为双黑，则将 P 作为当前要维护的节点，继续向上调整 |
