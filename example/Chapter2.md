...
**Instruction formats**
<div style="text-align: center"><img src="image-20.png" width="80%"></div> 
- Type of internal storage in <u>processer</u>
- The number of the memory operand in the instruction

---
## 2.2 Arithmetic Operations
- Only one operation per instruction
- Add and substract, three operands (Two sources and one destination)
	- `add a,b,c // a gets b + c` 
此处简单略过，下面有具体介绍
---

## 2.3 Operands
RISC-V has a 32 x **64-bit register** file（32 个 64 bit 的寄存器）
...
> [!Endianness]
> <div style="text-align: center"><img src="image-22.png" width="70%"></div> 
> 
...
> [!Memory Alignment]
> <div style="text-align: center"><img src="image-21.png" width="70%"></div>
> 
> - Unlike some other ISAs
> - 读取速度更快&内存占用更多
 
### 3. Brief Summary
<div style="text-align: center"><img src="image-42.png" width="70%"></div>
...
<div style="text-align: center"><img src="image-23.png" width="90%"></div>
 Instruction fields
...
<div style="text-align: center"><img src="image-24.png" width="90%"></div> 
...
<div style="text-align: center"><img src="image-25.png" width="90%"></div> 
...
==根据 opcode、funct 3 确定具体操作，读取 rs2 中存储的值，存入 rs1 + immediate 指向的地址==

> [!note]
> ![[系统硬件/计算机组成/images/image-26.png]]

---
## 2.6 Logical Operations
**Shift Operations**
- `sll, srl, slli, srli`
<div style="text-align: center"><img src="image-27.png" width="90%"></div> 
immed: 偏移量
- Shift left logical
...
==根据 opcode、funct 3、funct 6 确定具体操作，从 rs1、immed 读取值，将结果写入 rd==

**And Operations, Or Operations, Xor Operation, etc...**

> [!note] RISC-V operands
> ![[系统硬件/计算机组成/images/image-28.png]]
...
| If                                                                          | If-then-else                                                                |
| --------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| <div style="text-align: center"><img src="image-31.png" width="100%"></div> | <div style="text-align: center"><img src="image-33.png" width="100%"></div> |
| **LOOPs**                                                                   | **While**                                                                   |
| <div style="text-align: center"><img src="image-37.png" width="100%"></div> | <div style="text-align: center"><img src="image-39.png" width="100%"></div> |

**Hold out Case/Switch**
- Compiling a switch using <font color="#ff0000">jump address table</font>
> [! example]
...
> ```
> 如下图，根据 k 跳转到对应情况：
> <div style="text-align: center"><img src="image-41.png" width="60%"></div> 
> 最终流程：
> <div style="text-align: center"><img src="image-40.png" width="70%"></div> 
> 
...
#### **Instruction for procedures**: <font color="#ff0000">jal</font> (jump-and-link)
==Caller==：<font color="#ff0000">jal rd, ProcedureAddress</font>
...
#### **Procedure return**: <font color="#ff0000">jalr</font> (jump and link register)
==Callee==：<font color="#ff0000">jalr x0, 0(x1)</font>
...
临时寄存器&保留寄存器：
<div style="text-align: center"><img src="image-81.png" width="80%"></div> 
...
### 4. Memory Layout
> [!note]
>  <div style="text-align: center"><img src="image-193.png" width="30%"></div> 
...
> [!note]
> <div style="text-align: center"><img src="image-46.png" width="90%"></div> 
> 
...
> [!example]
> <div style="text-align: center"><img src="image-47.png" width="80%"></div> 
> 
...
> [!example]
> <div style="text-align: center"><img src="image-48.png" width="80%"></div> 
> 
...
- UJ format：
<div style="text-align: center"><img src="image-50.png" width="90%"></div> 
...
> Exit:
> ```
> <div style="text-align: center"><img src="image-51.png" width="80%"></div> 
> 
...
> <div style="text-align: center"><img src="image-53.png" width="90%"></div>
> 
> RISC-V Addressing Summary
> - 多种不同的寻址形式一般统称为 **寻址模式**（addressing mode）
>  <div style="text-align: center"><img src="image-54.png" width="90%"></div>
...
<div style="text-align: center"><img src="image-55.png" width="60%"></div>
...
![[系统硬件/计算机组成/images/image-56.png|336x204]]
...
![[系统硬件/计算机组成/images/image-57.png|273x328]]
...
> <div style="text-align: center"><img src="image-58.png" width="90%"></div>

> [!info] RISC-V 指令大全
> <div style="text-align: center"><img src="image-82.png" width="90%"></div>